...
static void _sha256_transform(sha256_ctx_t *ctx, const uint8_t data[])
{
...
int infra_sha256_once(lua_State* L)
{
    sha256_ctx_t ctx;
    sha256_init(&ctx);
